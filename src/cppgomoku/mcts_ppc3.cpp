...
namespace gomoku
{
    ...
    //ppc3 part
    Ppc3_MonteCarloSearchTree::Ppc3_MonteCarloSearchTree(float weight_c, int compute_budget, double time_budget,
    ...
    float Ppc3_MonteCarloSearchTree::evaluateRollout(Board &board, int limit) {
    ...
    void Ppc3_MonteCarloSearchTree::playout(Board &s) {
    ...
    int Ppc3_MonteCarloSearchTree::getMove(Board &s, float exploration_level) {
    ...
    void Ppc3_MonteCarloSearchTree::updateWithMove(int last_move) {
